...
public class ClientFactory {
    ...
    public static synchronized IClient getNamedClient(String name) {
    	System.out.println("\n\n((((((((((((Inside Simple Client))))))))))))");
    	for(Map.Entry<String, IClient<?,?>> simpleClient: simpleClientMap.entrySet()) {
    		System.out.println(simpleClient.getKey());
    	}
    	System.out.println("((((((((((((Inside Simple Client))))))))))))\n\n");
